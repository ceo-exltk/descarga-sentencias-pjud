...
usando la misma lógica de acceso a la API del PJUD que ya funciona
"""
...
class PJUDApiClient:
    def __init__(self):
        ...
        # Headers optimizados (copiados del worker funcional)
        ...
        # Configuración de tribunales (basada en el worker funcional)
    ...
    def consultar_total_por_tribunal(self, tribunal_type: str, csrf_token: str) -> int:
        ...
        try:
            ...
            # Parámetros de búsqueda (basados en el worker funcional)
            search_params = {
                    ...
                    if 'total' in data:
                        ...
                        if 'sentencias' in data and isinstance(data['sentencias'], list):
                            ...
                            if sentencias_count > 0:
                                ...
                                # Asumiendo 10 sentencias por página
    ...
    try:
        ...
        with open(filename, 'w', encoding='utf-8') as f:
            json.dump({
                ...
                'metodo': 'Consulta directa usando lógica del worker funcional'
